            ...
            <div class="container">
                ...
                <div class="event">
                    ...
                    <div class="package-list">
                        <!-- Package 1 -->
                        <div class="package-item">
                            <img src="../images/birthday1.jpg" alt="Birthday Basic Package">
                            <h4>Basic Package</h4>
                            <ul>
                                <li>Venue Decoration</li>
                        ...
                        <!-- Package 2 -->
                        <div class="package-item">
                            <img src="../images/birthday2.jpg" alt="Birthday Premium Package">
                ...
                <div class="event">
                    ...
                    <div class="package-list">
                        <!-- Package -->
                        <div class="package-item">
                            <img src="../images/babyshower1.jpg" alt="Baby Shower Delight Package">
                ...
                <div class="event">
                    ...
                    <div class="package-list">
                        <!-- Package -->
                        <div class="package-item">
                            <img src="../images/ringceremony1.jpg" alt="Ring Ceremony Elegant Package">
